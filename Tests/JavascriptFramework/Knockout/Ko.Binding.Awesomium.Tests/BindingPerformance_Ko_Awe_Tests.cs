...
namespace Ko.Binding.Awesomium.Tests
{
    ...
    public class BindingPerformance_Ko_Awe_Tests : HTLMBindingPerformanceTests
    {
        public BindingPerformance_Ko_Awe_Tests(AwesomiumKoContext context, ITestOutputHelper output)
